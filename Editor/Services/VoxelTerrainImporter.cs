...
namespace AweEditor
{
    ...
    public static class VoxelTerrainImporter
    {
        ...
        public static void UpdateStatus(string message)
        {
            ...
            status.Text += prepend + ">" + message + Environment.NewLine;
        }
        ...
        public static VoxelTerrain LoadTerrain(string filepath)
        {
            return ParseRegionFile(filepath);
        }

        private static VoxelTerrain ParseRegionFile(string filePath)
        {
        ...
        private static VoxelTerrain ParseChunks(string filePath, ChunkInformation[] chunkInfo)
        {
            ...
            for (int i = 0; i < chunkInfo.Length; i++)
            {
                ...
                if (chunkInfo[i].Offset != 0 && chunkInfo[i].Size != 0 && i == 1)
                {
